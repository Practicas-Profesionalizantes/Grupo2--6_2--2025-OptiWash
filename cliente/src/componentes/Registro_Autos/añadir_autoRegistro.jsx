...
function AñadirAutoRegistro({ onClose }) {
    ...
    <div className={styles.overlay}>
      <div className={styles["ventana-form"]}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>Patente</label>
          <input type="text" name="patente" value={form.patente} onChange={handleChange} required />
          ...
          <textarea name="nota" value={form.nota} onChange={handleChange} rows="3" />

          <div className={styles.botones}>
            <button type="button" className={styles.cancelar} onClick={() => onClose(false)}>
              Cancelar
            </button>
...
export default AñadirAutoRegistro;
